...
#region Loading Monitore
            ...
            this.LevelObjects(10, 188, 2, GameConstants.EnvObjects.MonitorGedreht);    // Erster Raum unten links
            this.LevelObjects(36.3f, 184.5f, 2, GameConstants.EnvObjects.MonitorGedreht);    // Raum links neben Klos
            this.LevelObjects(37.4f, 184.5f, 2, GameConstants.EnvObjects.MonitorGedreht);    // Raum links neben Klos
#endregion
...
#region Loading Rechner
            ...
            this.LevelObjects(10.5f, 190, 2, GameConstants.EnvObjects.RechnerGedreht);  // Erster Raum unten links
#endregion

#region Loading Poster

            this.LevelObjects(6.99f, 5, 2, GameConstants.EnvObjects.Mirkopir);
            this.LevelObjects(6.7f, 10, 2, GameConstants.EnvObjects.PosterVader);
            this.LevelObjects(6.7f, 25, 2, GameConstants.EnvObjects.PosterDeadpool);
            this.LevelObjects(6.7f, 32, 2, GameConstants.EnvObjects.PosterZombie);
            this.LevelObjects(6.7f, 40, 2, GameConstants.EnvObjects.PosterCat);
#endregion
...
#region Loading Whiteboards
            ...
            this.LevelObjects(21, 116.65f, 2, GameConstants.EnvObjects.WhiteboardGedreht);
...
#region Loading Pissour
            for (var i = 30; i<=45; i+=5)
            {
                ...
                this.LevelObjects(i, 140, 0, GameConstants.EnvObjects.PissoirGedreht);
            }
