...
namespace Finline.Code.GameState
{
    ...
    public class MainMenu : DrawableGameComponent
    {
        ...
        protected override void LoadContent()
        {
            ...
            this.guiElements[EMenuState.MainMenu].Find(x => x.AssetName == "ControlsButton").MoveElement(-200, -100); // move the "option" button down in y-direction
            ...
            #region CharacterSelectScreen Moved Elements
